module.exports = {
  ...
  oscInFilter: function(data) {
    ...
    if (address === '/key_pressure') {
      ...
      var h3 = tracks[x].H3
      //first two art buttons are toggles
      ...
      //rest art buttons are one-at-a-times, off is now a string
      ...
      //for toggle artics only
      //art1mode goes in the alphaFillOn property, where as in other buttons it goes in the off
      //PORT should be OSC3, non-toggles are OSC4
      if (art1name === "") {
      ...
      if (art2name === "") {
        ...
        //only sends to Cubase, will not update buttons in OSC
        sendOsc({
          address: art2type,
          args: [{
            type: 'i',
